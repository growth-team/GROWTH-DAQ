...
#include "yaml-cpp/yaml.h"
  ...
  RMAPHandler* GROWTH_FY2015_ADC::getRMAPHandler() { return rmapHandler; }
  ...
  void GROWTH_FY2015_ADC::setTriggerMode(size_t chNumber, TriggerMode triggerMode) throw(SpaceFibreADCException) {
  ...
  void GROWTH_FY2015_ADC::setStartingThreshold(size_t chNumber, uint32_t threshold) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  void GROWTH_FY2015_ADC::setClosingThreshold(size_t chNumber, uint32_t threshold) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  void GROWTH_FY2015_ADC::setTriggerBusMask(size_t chNumber, std::vector<size_t> enabledChannels) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  void GROWTH_FY2015_ADC::setDepthOfDelay(size_t chNumber, uint32_t depthOfDelay) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  uint32_t GROWTH_FY2015_ADC::getLivetime(size_t chNumber) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  uint32_t GROWTH_FY2015_ADC::getCurrentADCValue(size_t chNumber) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  void GROWTH_FY2015_ADC::turnOnADCPower(size_t chNumber) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  void GROWTH_FY2015_ADC::turnOffADCPower(size_t chNumber) throw(SpaceFibreADCException) {
    if (chNumber < SpaceFibreADC::NumberOfChannels) {
  ...
  bool GROWTH_FY2015_ADC::isAcquisitionCompleted(size_t chNumber) { return channelManager->isAcquisitionCompleted(chNumber); }
  ...
  void GROWTH_FY2015_ADC::setPresetMode(SpaceFibreADC::PresetMode presetMode) { channelManager->setPresetMode(presetMode); }

  void GROWTH_FY2015_ADC::setPresetLivetime(uint32_t livetimeIn10msUnit) { channelManager->setPresetLivetime(livetimeIn10msUnit); }
